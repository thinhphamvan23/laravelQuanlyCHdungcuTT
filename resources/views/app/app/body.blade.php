    ...
    <ul class="nav nav-tabs nav-justified mb-3" id="ex1" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="ex3-tab-1" data-mdb-toggle="tab" href="#ex3-tabs-1" role="tab"
                aria-controls="ex3-tabs-1" aria-selected="true">Bơi lội</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="ex3-tab-2" data-mdb-toggle="tab" href="#ex3-tabs-2" role="tab"
                aria-controls="ex3-tabs-2" aria-selected="false">Cắm trại</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="ex3-tab-3" data-mdb-toggle="tab" href="#ex3-tabs-3" role="tab"
                aria-controls="ex3-tabs-3" aria-selected="false">Gym</a>
        </li>
    </ul>
    <!-- Tabs navs -->
                    ...
                    <div class="card" style="margin-bottom: 25px">
                        <a href="/cua-hang/san-pham={{$giay['id_giay']}}">
                            <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light" >
                                <center><img src="{{ URL('images2/'.$giay->hinh_anh_1.'') }}" class="img-fluid" style="height:306px; width:306px"/></center>
...
<div class="card mb-3 shadow-1">
    <div class="card-body" style="margin-top:40px">
        <center>
            <h3 class="card-title" style="text-transform: uppercase;">SẢN PHẨM NỔI BẬT</h3>
        </center>
    </div>
    <br>
</div>
                ...
                @if($dem < 5) <div class="col-md-3">
                    <div class="card" style="margin-bottom: 25px">
                        <a href="/cua-hang/san-pham={{$giaynoibat->id_giay}}">
                            <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light" >
                                <center><img src="{{ URL('images2/'.$giaynoibat->hinh_anh_1.'') }}" class="img-fluid" style="height:306px; width:306px"/></center>
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                            </div>
                                    ...
                                    <script>
                                        $(function() {
                                            $(".RateDanhGia").rateYo({
                                                starWidth: "20px",
                                                ratedFill: "#16B5EA",
                                                rating: {{ $sosao[$giaynoibat->id_giay] }},
                                                readOnly: true,
                                            });
                                        });
                                    </script>
    
                                    <small class="text-muted float-end">( {{$soluongdanhgia[$giaynoibat->id_giay]}} Đánh giá
                                        )</small>
                                    <div class="RateDanhGia" class="float-end text-info"></div>
                                  </center>
                ...
                @if($dem < 5) <div class="col-md-3">
                    <div class="card" style="margin-bottom: 25px">
                        <a href="/cua-hang/san-pham={{$giaymoinhat->id_giay}}">
                            <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light" >
                                <center><img src="{{ URL('images2/'.$giaymoinhat->hinh_anh_1.'') }}" class="img-fluid" style="height:306px; width:306px"/></center>
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div>
                            </div>
                            <div class="card-body">
                                <center>
                                    ...
                                    <script>
                                        $(function() {
                                            $(".RateDanhGia").rateYo({
                                                starWidth: "20px",
                                                ratedFill: "#16B5EA",
                                                rating: {{ $sosao[$giaymoinhat->id_giay] }},
                                                readOnly: true,
                                            });
                                        });
                                    </script>
    
                                    <small class="text-muted float-end">( {{$soluongdanhgia[$giaymoinhat->id_giay]}} Đánh giá
                                        )</small>
                                    <div class="RateDanhGia" class="float-end text-info"></div>
