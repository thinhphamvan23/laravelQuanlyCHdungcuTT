...
<body style="padding: 0; margin: 0;">
    ...
    <button id="myFb"><img src="{{ URL('images1/fb.png') }}" height="40"></button>
    <button id="myPhon"><img src="{{ URL('images1/phon.png') }}" height="40"></button>

    <button id="myZalo"><img src="{{ URL('images1/zalo.jpg') }}" height="40"></button>
